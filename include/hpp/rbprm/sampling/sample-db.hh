...
namespace hpp {
  ...
  namespace sampling{
    ...
    HPP_RBPRM_DLLAPI T_OctreeReport GetCandidates(const SampleDB& sc, const fcl::Transform3f& treeTrf,
                                            ...
                                            const fcl::Vec3f& direction, const ZMPHeuristicParam & params, const heuristic evaluate = 0);
    ...
    HPP_RBPRM_DLLAPI bool GetCandidates(const SampleDB& sc, const fcl::Transform3f& treeTrf,
                                            const hpp::model::CollisionObjectPtr_t& o2,
                                            const fcl::Vec3f& direction, T_OctreeReport& report, const ZMPHeuristicParam & params, const heuristic evaluate = 0);
